...
class PyMsCognitiveWebSearch(PyMsCognitiveSearch):
    ...
    def _search(self, limit, format):
        ...
        payload = {
          ...
          'count' : '3', #currently 50 is max per search.
        ...
        #TODO Remove proxy when under no proxy
        response = requests.get(self.QUERY_URL, params=payload, headers=headers, proxies = proxies)
